...
{
    /// <inheritdoc />
    public partial class CreateGeust : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeddingGiftMoney = table.Column<double>(type: "float", nullable: false),
                    IsRefund = table.Column<bool>(type: "bit", nullable: false),
                    RefundValue = table.Column<double>(type: "float", nullable: false),
